...
export const BASEMAP_OVERLAYS: import('./types').BasemapDef[] = [
  ...
  {
    id: 'fed-ec-wetlands',
    label: 'Canadian Wetlands (EC)',
    type: 'raster',
    url: 'https://maps-cartes.ec.gc.ca/arcgis/rest/services/Canadian_Wetlands_Terre_Humides_du_Canada/MapServer/tile/{z}/{y}/{x}',
    attribution: '© Environment and Climate Change Canada',
    tile_size: 256,
    max_zoom: 18,
    group: 'Federal',
  },
  // ── Nova Scotia — additional services ─────────────────────────────────────
  {
    id: 'ns-atvans-trails',
    label: 'ATVANS Trails',
    type: 'nshn-vector',
    url: 'https://services1.arcgis.com/qpxtVXh93G601MmT/ArcGIS/rest/services/ATVANS_Trails_Data/FeatureServer/0/query',
    attribution: '© ATV Association of Nova Scotia',
    group: 'Nova Scotia',
    vector_config: {
      endpoint: 'https://services1.arcgis.com/qpxtVXh93G601MmT/ArcGIS/rest/services/ATVANS_Trails_Data/FeatureServer/0/query',
      geomType: 'line',
      outFields: 'OBJECTID',
      lineColor: '#e07b39',
      lineWidth: 1.5,
  ...
  },
  {
    ...
    label: 'SANS Trails',
    type: 'nshn-vector',
    url: 'https://services1.arcgis.com/qpxtVXh93G601MmT/ArcGIS/rest/services/SANS_Trails_Data/FeatureServer/0/query',
    attribution: '© Snowmobile Association of Nova Scotia',
    group: 'Nova Scotia',
    vector_config: {
      endpoint: 'https://services1.arcgis.com/qpxtVXh93G601MmT/ArcGIS/rest/services/SANS_Trails_Data/FeatureServer/0/query',
      geomType: 'line',
      outFields: 'OBJECTID',
      lineColor: '#5ba4e6',
      lineWidth: 1.5,
  ...
  {
    id: 'ns-nspi-power',
    label: 'NS Power Infrastructure (NSPI)',
    type: 'nshn-vector',
    url: 'https://services1.arcgis.com/qpxtVXh93G601MmT/arcgis/rest/services/NS_Power_Inc_Features/FeatureServer/0/query',
    attribution: '© Nova Scotia Power Inc.',
    group: 'Nova Scotia',
    vector_config: {
      endpoint: 'https://services1.arcgis.com/qpxtVXh93G601MmT/arcgis/rest/services/NS_Power_Inc_Features/FeatureServer/0/query',
      geomType: 'line',
      outFields: 'OBJECTID',
      lineColor: '#facc15',
      lineWidth: 1,
  ...
  {
    id: 'ns-campsite-leases',
    label: 'NS Campsite Leases',
    type: 'nshn-vector',
    url: 'https://services1.arcgis.com/qpxtVXh93G601MmT/ArcGIS/rest/services/Campsite_lease_license_and_related_features/FeatureServer/0/query',
    attribution: '© Nova Scotia Crown Lands',
    group: 'Nova Scotia',
    vector_config: {
      endpoint: 'https://services1.arcgis.com/qpxtVXh93G601MmT/ArcGIS/rest/services/Campsite_lease_license_and_related_features/FeatureServer/0/query',
      geomType: 'polygon',
      outFields: 'OBJECTID',
      lineColor: '#22c55e',
      lineWidth: 1,
